...
import parser.CSVStockParser;
import parser.TXTStockParser;
...
public class MockStockService {
    ...
    public MockStockService(String filename) {
        this.scanner = new Scanner(System.in);
        this.user = new User();
        
        // 파일 확장자에 따라 적절한 파서 선택
        StockDataParser parser = filename.endsWith(".csv") ? 
            new CSVStockParser() : new TXTStockParser();
        this.stockService = new StockService(parser, filename);
    }
